...
not to throw you in the deep end. You'll build real skills a little at a time,
and by the end you'll be ready to team up on real work.

**Everything here is real.** Even the warm-up tasks produce something useful — a
real event, a real message, a real piece of writing. Your time is valuable, so
we don't waste it on practice for its own sake.

Every page works the same way:

1. Read the short instructions.
2. Do the task in the real tool — there's always a link out.
3. Come back and check it off.
...
> Questions? Ask in the volunteer **Slack** — **#general** is the main channel,
> and there's a channel for each country/area we work on. Ask early and often;
> there are no silly questions here.

Ready? Start with [Get connected](/start/get-connected.md).
